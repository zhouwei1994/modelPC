...
Video.prototype = {
  ...
  _createPanel: function _createPanel() {
    ...
    var panel = new Panel(this, {
      ...
      tabs: [{
          title: '上传视频',
          tpl: '<div class="w-e-up-img-container">\n                    <div id="' + upTriggerId + '" class="w-e-up-btn">\n                        <i class="w-e-icon-upload2"></i>\n                    </div>\n                    <div style="display:none;">\n                        <input id="' + upFileId + '" type="file" multiple="multiple" accept="video/mp4,video/mpeg,video/3gp"/>\n                    </div>\n                </div>',
          events: [{
            // 触发选择图片
            ...
            fn: function fn() {
              ...
              if (fileList.length) {
                ...
                editor.customConfig.customUploadVideo(fileList);
              }
  ...
  _dragHandle: function _dragHandle() {
    ...
    $textElem.on('drop', function (e) {
      ...
      if (/\.(mp4|mpeg|3gp)$/.test(files[0].name)) {
        editor.customConfig.customUploadVideo(files)
      } else {
        // 上传图片
        var uploadImg = editor.uploadImg;
...
// 构造函数
export default function Editor(toolbarSelector, textSelector) {
...
Editor.prototype = {
  ...
  _initDom: function _initDom() {
    ...
    if (textSelector == null) {
      ...
      $textContainerElem.css('border', '1px solid #ccc').css('border-top', 'none').css('height', _this.config.height + 'px');
    } else {
